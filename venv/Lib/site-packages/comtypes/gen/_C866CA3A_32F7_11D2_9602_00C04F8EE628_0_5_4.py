...
__all__ = [
    'ISpeechPhoneConverter', 'tagSTATSTG', 'SDTReplacement',
    'SITooSlow', 'DISPID_SGRInitialState', 'SP_VISEME_17',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SPIAudioSizeBytes',
    'ISpeechRecoContext', 'DISPID_SAFGuid',
    'DISPID_SpeechObjectTokens', 'DISPID_SBSFormat',
    'ISpeechCustomStream', 'DISPID_SVSInputSentenceLength',
    'DISPID_SPRuleEngineConfidence', 'ISpNotifyTranslator',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SAFT11kHz16BitStereo',
    'ISpRecoCategory', 'ISpPhoneConverter', 'SPDKL_CurrentUser',
    'eLEXTYPE_PRIVATE1', 'DISPID_SVPause', 'SPAR_High',
    'SAFTNonStandardFormat', 'SPAO_RETAIN_AUDIO',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SPRs_NewEnum',
    'DISPID_SRRecognizer', 'SPSHT_Unknown',
    'ISpPhoneticAlphabetConverter', 'SPSTREAMFORMATTYPE',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpRecoGrammar2',
    'DISPID_SRGSetWordSequenceData', 'SPSLMA', 'DISPID_SLWsItem',
    'SpeechRuleAttributes', 'ISpeechDataKey', 'ISpeechPhraseRules',
    'SPPS_Noncontent', 'DISPID_SADefaultFormat',
    'DISPID_SLAddPronunciationByPhoneIds', 'eLEXTYPE_RESERVED8',
    'DISPID_SOTGetDescription', 'eLEXTYPE_PRIVATE15', 'SRESoundEnd',
    'ISpeechGrammarRule', 'SPSEMANTICFORMAT', 'SVSFNLPMask',
    'DISPID_SOTRemove', 'ISpeechAudioBufferInfo',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SpeechMemoryStream',
    'DISPID_SPRuleId', 'ISpeechObjectTokenCategory',
    'Speech_StreamPos_RealTime',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SPARecoResult',
    'SPVISEMES', 'DISPID_SPEPronunciation', 'DISPID_SLWType',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SRRTOffsetFromStart',
    'ISpeechGrammarRules', 'SVPAlert', 'DISPID_SGRAddState',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPEVENTENUM',
    'SpeechCategoryVoices', 'DISPID_SPRText',
    'DISPID_SpeechVoiceEvent', 'DISPID_SVVoice', 'SFTInput',
    'DISPID_SLPLangId', 'SPEI_RESERVED2', 'DISPIDSPTSI_ActiveOffset',
    'SPEI_WORD_BOUNDARY', 'ISpeechWaveFormatEx',
    'DISPID_SRCAudioInInterferenceStatus', 'SREStreamEnd',
    'SVSFParseAutodetect', 'SINoise', 'ISpRecoContext', 'SRTStandard',
    'SVSFIsXML', 'DISPID_SAEventHandle', 'SVSFNLPSpeakPunc',
    'SpeechWordType', 'DISPID_SpeechMMSysAudio', 'SPEI_TTS_BOOKMARK',
    'SpLexicon', 'SAFTCCITT_ALaw_11kHzMono', 'SpeechAllElements',
    'SECNormalConfidence', 'DISPID_SRRTStreamTime',
    'IInternetSecurityManager', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SOTCSetId', 'eLEXTYPE_RESERVED6',
    'DISPID_SPIEnginePrivateData', 'SpMMAudioIn',
    'DISPID_SPPs_NewEnum', 'SpeechTokenIdUserLexicon',
    'DISPID_SpeechFileStream', 'DISPID_SVVolume', 'DISPID_SOTsCount',
    'DISPID_SpeechRecoResultTimes', 'SPPS_LMA',
    'SpeechDataKeyLocation', 'ISpeechRecoGrammar',
    'DISPID_SRCERequestUI', 'DISPID_SDKGetStringValue',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SRCEAdaptation',
    'SPEI_END_INPUT_STREAM', 'ISpNotifySink',
    'SGLexicalNoSpecialChars', 'SpStream', 'SPSInterjection',
    'SPEI_PHRASE_START', 'DISPID_SPIEngineId', 'DISPID_SRProfile',
    'SVSFUnusedFlags', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SWFESamplesPerSec', 'eLEXTYPE_LETTERTOSOUND',
    'SPCONTEXTSTATE', 'eLEXTYPE_PRIVATE8', 'DISPID_SRCVoice',
    'DISPID_SPACommit', 'ISpeechBaseStream', 'DISPID_SPCPhoneToId',
    'ISpeechFileStream', 'DISPID_SGRSTPropertyValue', 'SPEI_VISEME',
    'ISpeechPhraseAlternates', 'SVP_11',
    'ISpeechTextSelectionInformation', 'SPWT_LEXICAL',
    'DISPID_SRSetPropertyString',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', '_ISpeechVoiceEvents',
    'DISPID_SPEsCount', 'SRSActiveAlways', 'DISPID_SABIEventBias',
    'SVSFlagsAsync', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SPIGrammarId', 'eWORDTYPE_DELETED', 'ISpeechObjectToken',
    'SpeechRecoContextState', 'ISpeechAudio', 'DISPID_SGRClear',
    'SpShortcut', 'SDTAudio', 'DISPID_SGRSAddRuleTransition',
    'SAFT24kHz8BitMono', 'ISpStreamFormatConverter',
    'DISPID_SDKDeleteKey', 'SPAUDIOOPTIONS', 'SpeechEngineConfidence',
    'SpPhraseInfoBuilder', 'DISPID_SDKGetBinaryValue', 'SPRECOSTATE',
    'SVP_5', 'eLEXTYPE_PRIVATE10', 'SVEAudioLevel',
    'SpeechVisemeType', 'DISPID_SpeechPhraseReplacements',
    'SPAO_NONE', 'SAFTCCITT_ALaw_8kHzMono', 'SVEWordBoundary',
    'SRERequestUI', 'DISPID_SFSOpen',
    'SpeechPropertyHighConfidenceThreshold', 'SP_VISEME_15',
    'DISPID_SGRsCount', 'ISpProperties',
    'SpeechStreamSeekPositionType', 'SREBookmark',
    'SpInprocRecognizer', 'DISPID_SRCERecognition', 'SVSFDefault',
    'SPPS_Function', 'SpTextSelectionInformation',
    'DISPID_SPPBRestorePhraseFromMemory', 'SAFT16kHz16BitStereo',
    'SAFTCCITT_ALaw_44kHzMono', 'IEnumString', 'DISPID_SBSRead',
    'DISPID_SpeechCustomStream', 'Speech_Max_Word_Length',
    'DISPID_SpeechAudioStatus', 'DISPID_SPRulesItem',
    'SAFT44kHz8BitMono', 'SPXMLRESULTOPTIONS', 'ISpRecoGrammar',
    'LONG_PTR', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SVSPhonemeId', 'DISPID_SLWWord', 'DISPID_SGRSTransitions',
    'SPBO_TIME_UNITS', 'ISpLexicon', 'ISpNotifySource',
    'SAFT11kHz8BitStereo', 'ISpObjectTokenCategory',
    'SWPUnknownWordUnpronounceable', 'DISPID_SVRate',
    'SpeechAudioFormatType', 'SVP_6', 'eLEXTYPE_PRIVATE14',
    'SREFalseRecognition', '_ISpeechRecoContextEvents',
    'DISPID_SVSVisemeId', 'SP_VISEME_11',
    'DISPID_SPEActualConfidence', 'SAFTDefault',
    'DISPID_SPILanguageId', 'DISPID_SpeechVoiceStatus',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SPELexicalForm',
    'SPFM_OPEN_READWRITE', 'SGRSTTRule', 'SVEPhoneme',
    'DISPID_SRSClsidEngine', 'SpeechRecognitionType', 'SPCS_ENABLED',
    'SAFT12kHz16BitMono', 'eLEXTYPE_RESERVED4',
    'DISPID_SWFEBlockAlign', 'SASClosed', 'SPSHORTCUTPAIR',
    'DISPID_SOTDataKey', 'DISPID_SRCEventInterests',
    'ISpRecoContext2', 'ISpeechPhraseInfoBuilder',
    'DISPID_SGRsCommitAndSave', 'SECFDefault', 'ISpXMLRecoResult',
    'SAFT32kHz8BitMono', 'SPPHRASEELEMENT',
    'DISPID_SpeechRecoResult2', 'SPRST_ACTIVE', 'DISPID_SRGState',
    'DISPID_SPRsItem', 'SAFT32kHz8BitStereo', 'SRSInactiveWithPurge',
    'SAFT22kHz16BitMono', 'SPAR_Low', 'SSFMOpenForRead',
    'DISPID_SpeechPhraseRule', 'SDA_No_Trailing_Space',
    'SPAUDIOBUFFERINFO', 'eLEXTYPE_PRIVATE3', 'SECFIgnoreWidth',
    'SECFIgnoreKanaType', 'SPPHRASE', 'DISPID_SPEsItem',
    'DISPID_SRSSupportedLanguages', 'SAFT11kHz8BitMono',
    'SpeechAudioProperties', 'SPGS_ENABLED', 'SPINTERFERENCE_NOISE',
    '__MIDL_IWinTypes_0009', 'ISpStream',
    'DISPID_SPERetainedStreamOffset', 'SP_VISEME_10',
    'SPEI_RESERVED5', 'SpFileStream', 'SpeechAudioFormatGUIDText',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SASState', 'SPWORDLIST',
    'ISpeechGrammarRuleStateTransitions', 'SpeechTokenContext',
    'SDTAlternates', 'DISPID_SRDisplayUI',
    'DISPID_SASFreeBufferSpace', 'DISPID_SRCESoundStart',
    'ISpGrammarBuilder', 'ISpeechPhraseRule',
    'DISPID_SLWPronunciations', 'DISPID_SGRSTType',
    'DISPID_SRCCmdMaxAlternates', 'SpeechAudioState',
    'SAFT8kHz8BitMono', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SGRs_NewEnum', 'SpeechVoiceSpeakFlags', 'SPAR_Medium',
    'SpeechVoiceCategoryTTSRate', 'SVP_15', 'DISPID_SPAsCount',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SWFEExtraData',
    'DISPID_SPIGetText', 'SpSharedRecoContext',
    'SpeechTokenKeyAttributes', 'DISPID_SVAudioOutput',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SpeechPhraseProperty',
    'DISPID_SVGetAudioInputs', 'DISPID_SpeechPhoneConverter',
    'SP_VISEME_3', 'SAFT22kHz16BitStereo', 'eLEXTYPE_PRIVATE9',
    'ISpAudio', 'SVPOver', 'SPWORDPRONOUNCEABLE',
    'SpeechVoicePriority', 'eLEXTYPE_PRIVATE16', 'SPFILEMODE',
    'SVSFIsFilename', 'DISPID_SRGCmdSetRuleIdState', 'SPVPRIORITY',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SVEVoiceChange',
    'ISpeechGrammarRuleState', 'DISPID_SRRDiscardResultInfo',
    'SAFT24kHz16BitStereo', 'DISPID_SLGenerationId', 'ISpPhrase',
    'DISPID_SPPId', 'STCRemoteServer', 'DISPID_SMSSetData',
    'SPEI_RESERVED3', 'SPEI_END_SR_STREAM', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SGRsDynamic', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SPPEngineConfidence', 'DISPID_SGRName',
    'SpeechGrammarTagDictation', 'SREAdaptation',
    'SpeechVoiceSkipTypeSentence', 'SGPronounciation',
    'DISPID_SpeechPhraseElements', 'SPLO_DYNAMIC', 'SPSHT_EMAIL',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRRAudioFormat',
    'SpeechVoiceEvents', 'SPINTERFERENCE_TOOQUIET', 'SpeechRuleState',
    'DISPID_SDKCreateKey', 'DISPID_SRCEPropertyStringChange',
    'SVP_20', 'SVP_0', 'DISPID_SRCEInterference', 'DISPID_SVEWord',
    'SPPS_Unknown', 'DISPID_SVResume', 'SpMemoryStream',
    'eLEXTYPE_PRIVATE2', 'SpMMAudioOut', 'DISPID_SGRAttributes',
    'DISPID_SABIBufferSize', 'eLEXTYPE_PRIVATE17',
    'SpInProcRecoContext', 'SAFTADPCM_11kHzMono', 'SPAS_CLOSED',
    'SWTAdded', 'SPEI_MAX_SR', 'DISPID_SOTCId',
    'SpeechTokenValueCLSID', 'DISPID_SPPName', 'ISpeechLexiconWord',
    'DISPID_SPEDisplayText', 'SpeechAddRemoveWord', 'DISPID_SVStatus',
    'SGRSTTEpsilon', 'DISPID_SVAudioOutputStream', 'SLODynamic',
    'DISPID_SRCRecognizer', 'DISPID_SRCEAudioLevel', 'SGDSActive',
    'SpNullPhoneConverter', 'DISPIDSPTSI_SelectionLength',
    'SSTTWildcard', 'SITooLoud', 'DISPID_SpeechPhraseElement',
    'DISPID_SOTCreateInstance', 'SREStateChange', 'SPPHRASERULE',
    'DISPID_SRCSetAdaptationData', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SREmulateRecognition', 'eLEXTYPE_APP',
    'SAFT22kHz8BitMono', 'SAFT48kHz8BitMono',
    'DISPID_SRCVoicePurgeEvent', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SpeechLexiconProns', 'eLEXTYPE_PRIVATE5',
    'SRAORetainAudio', 'DISPID_SpeechAudioFormat',
    'DISPID_SPAs_NewEnum', 'SPDKL_DefaultLocation', 'SP_VISEME_18',
    'SpSharedRecognizer', 'ISpPhraseAlt', 'SPCATEGORYTYPE',
    'SPEI_START_INPUT_STREAM', 'SpPhoneticAlphabetConverter',
    'DISPID_SRCRetainedAudioFormat', 'SGSExclusive',
    'DISPID_SRCreateRecoContext', 'DISPID_SASetState',
    'DISPID_SPEAudioSizeTime', 'DISPID_SMSALineId',
    'DISPID_SVEStreamEnd', 'DISPID_SpeechAudio',
    'SAFT22kHz8BitStereo', 'SpUnCompressedLexicon',
    'DISPID_SVEStreamStart', 'eLEXTYPE_USER',
    'DISPID_SVAlertBoundary', 'ISpDataKey', 'DISPID_SFSClose',
    'DISPID_SGRAddResource', 'ISpEventSink', 'DISPID_SRGReset',
    ...
    'STCInprocServer', 'DISPID_SAStatus', 'SPDKL_CurrentConfig',
    'SPSHORTCUTPAIRLIST', 'ISpPhoneticAlphabetSelection', 'SVEViseme',
    'SPSUnknown', 'DISPID_SRRAudio', 'SpeechStreamFileMode',
    'SVSFParseSsml', 'SPEI_SR_BOOKMARK', 'SPWORDTYPE',
    'SPVPRI_NORMAL', 'DISPID_SVDisplayUI', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRGDictationUnload', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SDKGetlongValue', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SRRSetTextFeedback', 'SpeechRegistryLocalMachineRoot',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPAStartElementInResult',
    'DISPID_SRRRecoContext', 'SGDSInactive', 'DISPID_SOTSetId',
    'SDA_One_Trailing_Space', 'DISPID_SCSBaseStream',
    'SpeechGrammarTagWildcard', 'SREPrivate',
    'DISPID_SLGetPronunciations', 'DISPID_SpeechRecoContext',
    ...
    'DISPID_SRCBookmark', 'DISPID_SPAsItem', 'DISPID_SOTCDefault',
    'DISPID_SRGIsPronounceable',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SOTId',
    'DISPID_SPIStartTime', 'DISPID_SPRDisplayAttributes',
    'SPWAVEFORMATTYPE', 'SpeechRetainedAudioOptions',
    'SRERecoOtherContext', 'DISPID_SGRSTRule',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SOTs_NewEnum',
    'SPPS_Interjection', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SAFType', 'ISpeechPhraseAlternate',
    'DISPID_SVGetProfiles', 'SPRECORESULTTIMES', 'STSF_FlagCreate',
    'DISPID_SPRFirstElement', 'SFTSREngine', 'SPSNotOverriden',
    'DISPID_SpeechVoice', 'eLEXTYPE_PRIVATE18', 'SVP_19',
    'DISPID_SRCPause', 'SP_VISEME_20', 'DISPID_SDKSetBinaryValue',
    'DISPID_SRGDictationSetState', 'SAFTCCITT_ALaw_11kHzStereo',
    'SVEEndInputStream', 'ISpeechMMSysAudio', 'SPEI_VOICE_CHANGE',
    'DISPID_SpeechGrammarRule', 'SRESoundStart', 'DISPIDSPRG',
    'DISPID_SRCEPhraseStart', '_SPAUDIOSTATE',
    'SPADAPTATIONRELEVANCE', 'DISPID_SpeechLexiconWord',
    'SPWT_PRONUNCIATION', 'ISpShortcut', 'DISPID_SRAudioInputStream',
    'SVP_12', 'DISPID_SVEPhoneme', 'ISpeechAudioStatus',
    'IInternetSecurityMgrSite', 'SDTDisplayText',
    'DISPID_SOTRemoveStorageFileName', 'SPVOICESTATUS',
    'DISPID_SRIsUISupported', 'SDTAll',
    'DISPID_SpeechPhraseAlternate', 'ISpeechRecoResult',
    'DISPID_SRGCmdSetRuleState', 'SAFT44kHz8BitStereo',
    'SAFT8kHz16BitMono', 'DISPID_SLWs_NewEnum', 'SRAExport',
    'SPPS_SuppressWord', 'SRSEDone', 'SpeechLexiconType',
    'DISPID_SVPriority', 'SPSHORTCUTTYPE', 'SAFT12kHz8BitStereo',
    'SPEI_RECO_OTHER_CONTEXT', 'SAFT16kHz8BitStereo',
    'ISpeechObjectTokens', 'SAFTADPCM_44kHzStereo', 'SVF_Emphasis',
    'DISPID_SRCRequestedUIType', 'DISPID_SABufferInfo',
    'DISPID_SPAPhraseInfo', 'SpeechRecoEvents', 'SPBO_NONE',
    'SpObjectTokenCategory', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SRStatus', 'eLEXTYPE_RESERVED10', 'SpNotifyTranslator',
    'SPAUDIOSTATE', 'SPCT_DICTATION', 'eLEXTYPE_PRIVATE19',
    'DISPID_SABIMinNotification', 'DISPID_SWFEAvgBytesPerSec',
    'SPRS_INACTIVE', 'DISPID_SRGetRecognizers', 'SPWT_DISPLAY',
    'SPCS_DISABLED', 'SPAS_RUN', 'SBONone', 'DISPID_SRCResume',
    'SAFT32kHz16BitStereo', 'STCLocalServer', 'DISPID_SRCEBookmark',
    'SLTUser', 'DISPID_SPRuleChildren', 'DISPID_SPIElements',
    'SITooFast', 'SAFTADPCM_8kHzMono', 'SAFTADPCM_11kHzStereo',
    'SVP_17', 'ISpeechVoiceStatus', 'SRSEIsSpeaking',
    'SPCT_SUB_DICTATION', 'SPVPRI_OVER',
    'DISPID_SPIAudioStreamPosition',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SpeechDataKey', 'SPFM_CREATE_ALWAYS',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SRCRetainedAudio',
    'DISPID_SPPsCount', 'SP_VISEME_12', 'DISPID_SVSLastResult',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SGRsItem', 'SPWF_SRENGINE',
    'UINT_PTR', 'DISPID_SPEAudioStreamOffset', 'SPSERIALIZEDRESULT',
    'SPEI_SOUND_END', 'SPEI_RECOGNITION',
    'DISPID_SRGetPropertyNumber', 'SPRST_NUM_STATES',
    'DISPID_SVEventInterests', 'SPAR_Unknown',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SOTGetAttribute',
    'SVP_4', 'SAFTCCITT_ALaw_22kHzStereo', 'SPRS_ACTIVE',
    'SRADynamic', 'SPPS_NotOverriden', 'SPFM_OPEN_READONLY',
    'DISPID_SpeechRecoContextEvents', 'SINoSignal',
    'SPINTERFERENCE_NONE', 'SAFTCCITT_uLaw_44kHzMono',
    'SpeechPropertyResponseSpeed', 'SPPS_RESERVED4',
    'ISpeechPhraseElements', 'DISPID_SDKOpenKey',
    'SPTEXTSELECTIONINFO', 'SPBO_AHEAD', 'DISPID_SRRTLength',
    'SP_VISEME_4', 'SAFTGSM610_22kHzMono', 'STSF_LocalAppData',
    'IEnumSpObjectTokens', 'SGRSTTDictation',
    'DISPID_SVSLastStreamNumberQueued', 'ISpeechRecoResult2',
    'STCAll', 'SPSHT_NotOverriden', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SVSpeakCompleteEvent',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SpeechTokenShellFolder',
    'SBOPause', 'SPEI_TTS_PRIVATE', 'SpCustomStream',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SRRGetXMLResult',
    'ISpObjectWithToken', 'SpeechPropertyAdaptationOn',
    'DISPID_SWFEBitsPerSample', 'SpeechInterference',
    'DISPID_SDKEnumValues', 'DISPID_SPRuleParent', 'SRCS_Enabled',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPRuleNumberOfElements',
    'SPGRAMMARSTATE', 'DISPID_SPIGetDisplayAttributes', 'SRSInactive',
    'DISPID_SVWaitUntilDone', 'ISpRecognizer', 'DISPID_SRRAlternates',
    'SAFT44kHz16BitMono', 'SpStreamFormatConverter',
    'DISPID_SPISaveToMemory', 'ISpRecognizer2',
    'DISPID_SRSAudioStatus', 'STSF_AppData', 'DISPID_SOTDisplayUI',
    'DISPID_SRGCommit', 'SPPS_Verb', 'SP_VISEME_9', 'SLTApp',
    'SAFT32kHz16BitMono', 'SPPS_RESERVED2', 'SPFM_CREATE',
    'SPGRAMMARWORDTYPE', 'SPEI_RESERVED6', 'DISPID_SVEAudioLevel',
    'SpeechRecognizerState', 'SPEI_HYPOTHESIS', 'SITooQuiet',
    'DISPID_SPIProperties', 'SRSActive', 'ISpeechRecognizerStatus',
    'SP_VISEME_14', 'DISPID_SOTMatchesAttributes',
    'DISPID_SVSLastBookmarkId', 'SpeechAudioFormatGUIDWave',
    'DISPID_SpeechLexicon', 'SPGS_EXCLUSIVE', 'DISPID_SRCESoundEnd',
    'SVF_None', 'IStream', 'SRARoot', 'SPEI_UNDEFINED', 'SPSNoun',
    'DISPID_SRCEFalseRecognition', 'DISPIDSPTSI', 'SPAUDIOSTATUS',
    'DISPID_SGRSAddSpecialTransition', 'ISpeechPhraseReplacements',
    'SAFTADPCM_44kHzMono', 'SREHypothesis', 'SpeechAudioVolume',
    'SREPropertyNumChange', 'DISPID_SRSCurrentStreamPosition',
    'STSF_CommonAppData', 'ISpeechPhraseElement', 'DISPID_SLPsItem',
    'SpeechEngineProperties', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SVESentenceBoundary', 'ISpRecognizer3', 'SDTRule',
    'eLEXTYPE_MORPHOLOGY', 'SPRECOGNIZERSTATUS',
    'DISPID_SDKSetStringValue', 'eLEXTYPE_PRIVATE13',
    'SWPUnknownWordPronounceable', 'SPPHRASEREPLACEMENT',
    'SpeechCategoryAppLexicons', 'DISPID_SRCEPropertyNumberChange',
    'SpeechTokenKeyUI', 'DISPID_SRAudioInput',
    'DISPIDSPTSI_SelectionOffset', 'SP_VISEME_2',
    'SpeechPropertyNormalConfidenceThreshold', 'SPRECOCONTEXTSTATUS',
    'ISpeechAudioFormat', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SVEEnginePrivate', 'DISPID_SPIAudioSizeTime',
    'SSFMCreate', 'SRATopLevel', 'SAFTText', 'SpMMAudioEnum',
    'DISPID_SWFEChannels', 'DISPID_SVEVoiceChange', 'SVP_10',
    'SpeechDiscardType', 'SVP_8', 'DISPID_SPPValue', 'SWTDeleted',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SVGetAudioOutputs',
    'SPPROPERTYINFO', 'SGRSTTWord', 'DISPID_SRGetPropertyString',
    'SVP_9', 'DISPID_SRRTimes', 'STCInprocHandler',
    'SpeechDisplayAttributes', 'SP_VISEME_13', 'SVP_3',
    'SAFT24kHz16BitMono', 'SPRULE', 'SAFT44kHz16BitStereo',
    'SVEBookmark', 'DISPID_SBSSeek', 'SAFT12kHz16BitStereo',
    'SPCT_COMMAND', 'SPINTERFERENCE_TOOSLOW', 'DISPID_SRGRules',
    'SAFT48kHz16BitStereo', 'SPCT_SLEEP', 'SGSDisabled', 'SPBO_PAUSE',
    'SAFTGSM610_44kHzMono', 'SpeechDictationTopicSpelling',
    'SpCompressedLexicon', 'SVSFPersistXML',
    'SpeechCategoryRecoProfiles', 'SDTProperty', 'SDKLCurrentUser',
    'SpeechPropertyComplexResponseSpeed',
    'DISPID_SPEEngineConfidence', 'eLEXTYPE_PRIVATE12',
    'SAFT24kHz8BitStereo', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SAVolume', 'ISpeechResourceLoader', 'DISPID_SLWLangId',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SPIReplacements',
    'eLEXTYPE_PRIVATE7', 'SVF_Stressed', 'SASStop',
    'SAFT16kHz16BitMono', 'DISPID_SpeechPhraseProperties',
    'SLOStatic', 'SPVPRI_ALERT', 'SSFMOpenReadWrite',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SGDisplay',
    'SPEVENT', 'SpeechFormatType', 'SRAONone', 'SSTTTextBuffer',
    'DISPID_SABufferNotifySize', 'SVEStartInputStream',
    'SREPhraseStart', 'ISpeechPhraseProperties',
    'SAFTADPCM_8kHzStereo', 'SVP_7', 'SPWORDPRONUNCIATION',
    'DISPID_SGRsCommit', 'DISPID_SGRSTNextState', 'SPEI_ADAPTATION',
    'SAFT8kHz16BitStereo', 'DISPID_SpeechPhraseInfo',
    'SPEI_INTERFERENCE', 'SGDSActiveUserDelimited',
    'DISPID_SVSInputWordPosition', 'SVSFParseSapi',
    'DISPID_SPRuleConfidence', 'DISPID_SRSCurrentStreamNumber',
    'SRTReSent', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SGRSTs_NewEnum', 'SpeechCategoryRecognizers',
    'SPEI_REQUEST_UI', 'SP_VISEME_7', 'SRTSMLTimeout',
    'DISPID_SDKSetLongValue', 'DISPID_SMSAMMHandle',
    'DISPID_SPPsItem', 'SAFTCCITT_uLaw_44kHzStereo',
    'SpeechWordPronounceable', 'ISpeechPhraseReplacement',
    'SP_VISEME_1', 'SP_VISEME_8', 'DISPID_SPEs_NewEnum',
    'SSFMCreateForWrite', 'DISPID_SRSetPropertyNumber',
    'SRCS_Disabled', 'DISPID_SOTGetStorageFileName',
    'SPDATAKEYLOCATION', 'SAFT11kHz16BitMono', 'SPGS_DISABLED',
    'SpeechVisemeFeature', 'DISPID_SPPNumberOfElements',
    'eLEXTYPE_RESERVED7', 'SVEAllEvents', 'DISPID_SMSADeviceId',
    'SPSERIALIZEDPHRASE', 'DISPID_SVGetVoices', 'SPEI_MAX_TTS',
    'SRERecognition', 'SRAInterpreter', 'SpeechEmulationCompareFlags',
    'SpVoice', 'Speech_Default_Weight', 'SPXRO_SML',
    'SpeechLoadOption', 'DISPID_SLPPhoneIds', 'DISPID_SRIsShared',
    'DISPID_SRGSetTextSelection', 'DISPID_SRGCmdLoadFromObject',
    'SGRSTTTextBuffer', 'SpeechRunState', 'SpeechGrammarState',
    'ISequentialStream', 'DISPID_SASNonBlockingIO', 'SINone',
    'SPLEXICONTYPE', 'SpeechPartOfSpeech', 'SASPause', 'DISPID_SGRId',
    'SDA_Consume_Leading_Spaces', 'DISPID_SPIRule',
    'DISPID_SPIRetainedSizeBytes', 'SVP_16', 'WAVEFORMATEX',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SPEAudioSizeBytes',
    'SWPKnownWordPronounceable', 'DISPID_SPCIdToPhone',
    'DISPID_SLWsCount', 'SpObjectToken', 'ISpeechXMLRecoResult',
    'DISPID_SPPChildren', 'SECFNoSpecialChars', 'SPPHRASEPROPERTY',
    'SpeechRegistryUserRoot', 'eLEXTYPE_PRIVATE6', 'SPSVerb',
    'SAFTGSM610_11kHzMono', 'ISpeechRecoResultDispatch', 'SASRun',
    'SGSEnabled', 'SPEI_PHONEME', 'SpeechPropertyResourceUsage',
    'SPFM_NUM_MODES', 'DISPID_SVIsUISupported', 'SECLowConfidence',
    'SP_VISEME_6', 'ISpVoice', 'DISPID_SDKEnumKeys',
    'eLEXTYPE_PRIVATE20', 'SPSHT_OTHER', 'DISPID_SOTsItem',
    'DISPID_SRGetFormat', 'SPAS_PAUSE', 'SVSFParseMask',
    'SPEI_PROPERTY_STRING_CHANGE', 'SP_VISEME_16',
    'eLEXTYPE_PRIVATE11', 'SVEPrivate', 'SVP_2', 'DISPID_SGRsAdd',
    'DISPID_SVEViseme', 'SDTPronunciation', 'SAFT8kHz8BitStereo',
    'ISpeechPhraseInfo', 'DISPID_SLPType', '_RemotableHandle',
    'ISpResourceManager', 'DISPID_SRRPhraseInfo',
    'DISPID_SOTCategory', 'DISPID_SpeechXMLRecoResult', 'SPSFunction',
    'SAFT16kHz8BitMono', 'SpPhoneConverter', 'SPWF_INPUT',
    'DISPID_SRCState', 'SAFTGSM610_8kHzMono', 'DISPID_SGRSTWeight',
    'SRTEmulated', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'ISpStreamFormat', 'SVSFVoiceMask', 'SPRULESTATE',
    'DISPID_SpeechLexiconPronunciation', 'ISpeechMemoryStream',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SGRSRule',
    'DISPID_SVEBookmark', 'ISpeechLexiconPronunciation',
    'ISpeechRecoResultTimes', 'SPAS_STOP', 'SPEI_RECO_STATE_CHANGE',
    'SP_VISEME_19', 'SECFIgnoreCase', 'SPWORD', 'DISPID_SGRSTsItem',
    'SPEVENTSOURCEINFO', 'DISPID_SRCEEndStream',
    'DISPID_SGRSAddWordTransition', 'DISPID_SLGetWords',
    'DISPID_SRCEStartStream', 'SREStreamStart',
    'DISPID_SWFEFormatTag', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SLGetGenerationChange', 'ISpeechRecognizer', 'SVP_1',
    'DISPID_SpeechGrammarRules', 'DISPID_SPRNumberOfElements',
    'DISPID_SRCCreateGrammar', 'DISPID_SPPFirstElement',
    'DISPID_SBSWrite', 'DISPID_SLPs_NewEnum', 'SVSFIsNotXML',
    'DISPID_SGRSTPropertyId', 'SVPNormal', 'ISpEventSource',
    'ISpeechLexiconWords', 'SVP_21', 'ISpObjectToken', 'SREAllEvents',
    'SPLO_STATIC', 'SP_VISEME_21', 'DISPID_SRRSaveToMemory',
    'DISPID_SRGId', 'SPBOOKMARKOPTIONS',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SDKDeleteValue',
    'DISPID_SRGCmdLoadFromFile', 'SPEI_MIN_SR', 'SPPS_RESERVED1',
    'DISPID_SpeechBaseStream', 'DISPID_SLPPartOfSpeech',
    'SGRSTTWildcard', 'SPXRO_Alternates_SML', 'SPLOADOPTIONS',
    'SAFTCCITT_ALaw_44kHzStereo', 'SVP_18',
    'SPRST_INACTIVE_WITH_PURGE', 'SAFT48kHz8BitStereo',
    'SPDKL_LocalMachine', 'DISPID_SRCCreateResultFromMemory',
    'SREAudioLevel', 'DISPID_SOTCGetDataKey',
    'ISpeechLexiconPronunciations', 'SpAudioFormat',
    'DISPID_SVSRunningState', 'DISPID_SRRSpeakAudio',
    'DISPID_SGRSTText', 'SAFTExtendedAudioFormat', 'DISPID_SRState',
    'DISPID_SLPsCount', 'DISPID_SRGRecoContext',
    'DISPID_SpeechObjectToken', 'DISPID_SVSkip', 'SPCT_SUB_COMMAND',
    'SpeechGrammarWordType', 'SpeechCategoryAudioIn',
    'DISPID_SVSpeak', 'SDKLLocalMachine', 'SSSPTRelativeToStart',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SGRSTPropertyName',
    'DISPID_SVSInputWordLength', 'SAFTADPCM_22kHzStereo', 'SVP_13',
    'SpeechSpecialTransitionType', 'SPPS_RESERVED3',
    'DISPID_SpeechRecognizer', 'Speech_Max_Pron_Length',
    'DISPID_SpeechPhraseRules', 'SDKLCurrentConfig',
    'DISPID_SRGDictationLoad', 'DISPID_SGRsFindRule',
    'tagSPPROPERTYINFO', 'SpeechTokenKeyFiles', 'SSTTDictation',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPSMF_UPS', 'SPBINARYGRAMMAR',
    'DISPID_SVSInputSentencePosition', 'SPEI_SR_RETAINEDAUDIO',
    'SECFEmulateResult', 'SPEI_SR_PRIVATE', 'SPRST_INACTIVE',
    'SDTLexicalForm', 'DISPID_SPERequiredConfidence',
    'ISpSerializeState', 'SPINTERFERENCE', 'SECHighConfidence',
    'ISpMMSysAudio', 'SPEI_RESERVED1', 'SAFT48kHz16BitMono',
    'ISpeechVoice', 'SpResourceManager',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SREInterference',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SGRSTsCount',
    'DISPID_SPPConfidence', 'SGDSActiveWithAutoPause',
    'DISPID_SPRuleName', 'SpeechMicTraining',
    'DISPID_SLAddPronunciation', 'SPSSuppressWord',
    'DISPID_SPCLangId', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SPPParent', 'SRAImport', 'eLEXTYPE_RESERVED9',
    'SSSPTRelativeToEnd', 'SpeechCategoryAudioOut',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SPRsCount', 'SPEI_MIN_TTS',
    'SGLexical', 'SpWaveFormatEx', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SVESentenceBoundary', 'SAFTADPCM_22kHzMono',
    'SPSEMANTICERRORINFO', 'DISPID_SLRemovePronunciation',
    'ISpeechPhraseProperty', 'DISPID_SOTIsUISupported',
    'DISPID_SLPSymbolic', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SPRuleFirstElement', 'ISpeechLexicon',
    'DISPID_SPEDisplayAttributes', 'SAFT12kHz8BitMono',
    'DISPID_SPRules_NewEnum', 'SRADefaultToActive',
    'SDKLDefaultLocation', 'SDA_Two_Trailing_Spaces', 'SVP_14',
    'SPPS_Noun', 'SRTExtendableParse', 'eLEXTYPE_PRIVATE4',
    'DISPID_SVSLastBookmark', 'DISPID_SMSGetData', 'SPEI_SOUND_START',
    'SPSModifier', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SRSNumberOfActiveRules', 'SAFTNoAssignedFormat',
    'SAFTCCITT_uLaw_11kHzStereo', 'SpeechRecoProfileProperties',
    'DISPID_SPRulesCount', 'DISPID_SVSpeakStream',
    ...
    'eWORDTYPE_ADDED', 'DISPID_SRCEEnginePrivate', 'SP_VISEME_0',
    'SP_VISEME_5', 'DISPID_SRCEHypothesis', 'SpeechBookmarkOptions',
    'SRTAutopause', 'Speech_StreamPos_Asap', 'DISPID_SRRTTickCount',
    'DISPID_SpeechWaveFormatEx'
]

_check_version('1.2.0', 1700059276.061747)
